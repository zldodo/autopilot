...
private:
  void callbackVelocityReport(const tier4_vehicle_msgs::msg::VelocityReport::SharedPtr msg);

  rclcpp::Subscription<tier4_vehicle_msgs::msg::VelocityReport>::SharedPtr
    vehicle_report_sub_;
