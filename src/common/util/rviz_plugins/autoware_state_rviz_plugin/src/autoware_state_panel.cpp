...
void AutowareStatePanel::onInitialize()
{
  ...
  sub_gear_ = raw_node_->create_subscription<tier4_vehicle_msgs::msg::Shift>(
...
void AutowareStatePanel::onShift(
  const tier4_vehicle_msgs::msg::Shift::ConstSharedPtr msg)
{
  switch (msg->data) {
    case tier4_vehicle_msgs::msg::Shift::PARKING:
      gear_label_ptr_->setText("PARKING");
      break;
    case tier4_vehicle_msgs::msg::Shift::REVERSE:
      gear_label_ptr_->setText("REVERSE");
      break;
    case tier4_vehicle_msgs::msg::Shift::DRIVE:
      gear_label_ptr_->setText("DRIVE");
      break;
    case tier4_vehicle_msgs::msg::Shift::LOW:
