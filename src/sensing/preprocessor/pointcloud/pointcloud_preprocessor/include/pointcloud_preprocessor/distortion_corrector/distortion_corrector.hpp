...
{
using tier4_vehicle_msgs::msg::VelocityReport;
...
private:
  ...
  void onVelocityReport(const tier4_vehicle_msgs::msg::VelocityReport::ConstSharedPtr velocity_report_msg);
  bool getTransform(
    const std::string & target_frame, const std::string & source_frame,
    tf2::Transform * tf2_transform_ptr);

  bool undistortPointCloud(
    const std::deque<tier4_vehicle_msgs::msg::VelocityReport> & velocity_report_queue,
  ...
  rclcpp::Subscription<tier4_vehicle_msgs::msg::VelocityReport>::SharedPtr velocity_report_sub_;
  ...
  std::deque<tier4_vehicle_msgs::msg::VelocityReport> velocity_report_queue_;
